...
filename = r'C:\Users\Abhinav Gupta\PycharmProjects\ISA Project\finalized1_text_model.sav'
...
def url_prediction(list):
    ...
    filename = r'C:\Users\Abhinav Gupta\PycharmProjects\ISA Project\URL Classification\urlphishing.sav'
